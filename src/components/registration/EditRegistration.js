                            ...
                            <FormGroup className="mb-2 me-sm-2 mb-sm-0 mt-3">
                                <Row className="form-check">
                                    <Col className="col-md-1 col-sm-1">
                                        {
                                            prevChecked.indexOf("resourcegroups") != -1 ?
                                                <Input className="form-check-input" checked onChange={e => { set(e.target.value) }} type="checkbox" value="resourcegroups" id="defaultCheck1" /> :
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                        {
                                            prevChecked.indexOf("virtualmachines") != -1 ?
                                                <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="virtualmachines" id="defaultCheck1" /> :
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                        {
                                            prevChecked.indexOf("virtualnetworks") != -1 ?
                                                <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="virtualnetworks" id="defaultCheck1" /> :
                                                <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="virtualnetworks" id="defaultCheck1" />
                                        }
                                    </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="networksecuritygroups" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="networksecuritygroups" id="defaultCheck1" />
                                        }
                                        </Col>
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="disks" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="disks" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="storageaccounts" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="storageaccounts" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="publicipaddresses" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="publicipaddresses" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="databases" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="databases" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="servers" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="servers" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="subnets" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="subnets" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
                                    ...
                                    <Col className="col-md-1 col-sm-1">
                                    {
                                            ...
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} checked type="checkbox" value="loadbalancers" id="defaultCheck1" /> :
                                            <Input className="form-check-input" onChange={e => { set(e.target.value) }} type="checkbox" value="loadbalancers" id="defaultCheck1" />
                                        }
                                        </Col>
                                    <Col className="col-md-4 col-sm-4">
                                        <Label className="form-check-label" for="defaultCheck1">
