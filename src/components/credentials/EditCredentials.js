...
const EditCredentials = () => {
  ...
  const handle = () => {
    ...
    axiosInstance
      .put(`/servicediscovery/credentials/${params.id}`, data, config)
      .then((res) => {
        console.log(res);
          ...
          <Col className="col-md-4 col-sm-4">
            <Form inline className="">
              <FormGroup className="mb-2 me-sm-2 mb-sm-0">
                <Label className="ml-0" for="provider">
                  Provider
                </Label>
                <Input
                  name="provider"
              ...
              <FormGroup className="mb-2 me-sm-2 mb-sm-0">
                <Label className="ml-0" for="username">
                  Account Username
                </Label>
                <Input
                  name="username"
                  ...
                  onChange={(e) => {
                    changeApplication(e.target.value);
                  }}
              ...
              <FormGroup className="mb-2 me-sm-2 mb-sm-0">
                <Label className="ml-0" for="subscriptionid">
                  Subscription ID
                </Label>
                <Input
                  name="subscriptionid"
                  ...
                  onChange={(e) => {
                    changeSubscription(e.target.value);
                  }}
              ...
              <FormGroup className="mb-2 me-sm-2 mb-sm-0">
                <Label className="ml-0" for="tenantid">
                  Tenant ID
                </Label>
                <Input
                  name="tenantid"
              ...
              <Button
                onClick={(e) => handle()}
                className="mt-3 btn-secondary btn-lg"
              >
                Add
              </Button>
            </Form>
